  ...
  return (
    <div className="flex items-center p-2 bg-white shadow-lg rounded-lg border-l-4 border-green-500">
      ...
      <div className="flex-1">
        ...
        <img src={imageurl} alt="produtName" className="h-10"/>
         ...
         toast.custom(
          (t) => (
            ...
            imageurl={selectedImage}
              productName={productDetails?.name["en-US"]}
            />
          ),
          {
            duration: 3000,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              {productDetails?.name["en-US"]}
            </h1>
            <p className="text-gray-500 mt-2 dark:text-gray-400">
              {productDetails?.description["en-US"]}
            </p>
            ...
            <button
              ...
              className="w-full py-2 bg-gray-500 text-white rounded-full transition-transform duration-300 hover:scale-105 mt-4"
            >
              Add to Cart
            </button>
          </div>
